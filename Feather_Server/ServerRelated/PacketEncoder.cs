...
namespace Feather_Server.ServerRelated
{
    ...
    public static class PacketEncoder
    {
        ...
        #region myshop (YB/gold/goldsilver shop)
        // add value: gold
        // buy_adv yuanbao 100

        public static void openMyShop(Hero p, ref byte[] pkts)
        {
            // open shop:
            // myshop open
            // change page:
            ...
            // buy:
            //            Gold/GS
            //              C P IP descID Amount
            // myshop buy 1 2 1 21 152241 2
            // desc item:
            //             C P IP
            // myshop info 3 2 11
            // try item (wear):
            //            C P IP
            // myshop try 5 2 5
            //                  parts 69: head // TODO: review packet
            //                     itemModelID         ?         ?
            // srv reply: __ ac 69 6600 0000 0000 0000 0800 0000 2f6a 0000 00
            //                  parts 6b: body
            //                     itemModelID
            // srv reply: __ ac 6b 1200 0000 00000000 00
            //                  parts 6e: tail
            //                     itemModelID
            // srv reply: __ ac 6e 0700 0000 00000000 00

            // __ ac 67 <4bytes> 00 <-- goldsilver (銀元)
            //          cate     page     itemPos- itemID-- itemID-- ?------- ?------- price--- quality- 
            // __ ac 65 01000000 01000000 01000000 e7530200 e7530200 00000000 00000000 0a000000 01000000 00000000 00000000 00 // cate1, page 1, top left item: bronze exp egg

            // .\openYBshop_CD 8C 58 E3 21 E5 E3 07 2A 9C 1E AD 8C 05 8E 4C 78 FA 8B 15 0A A0 C0 41 5A 41 97 0F DD 1E FB 9D.pcapng :
            // { "1588163600.31172": { "data": ["6d7973686f70206f70656e0d0a000000"], "srv": false, "idx": 1}, "1588163600.512121": {"data": ["", "07ac670000000000", "2fac65010000000100000001000000e7530200e753020000000000000000000a00000001000000000000000000000000", "2fac65010000000100000002000000ea530200ea53020000000000000000000800000001000000000000000000000000", "2fac65010000000100000003000000e6530200e653020000000000000000003200000002000000000000000000000000", "2fac65010000000100000004000000e9530200e953020000000000000000000a00000002000000000000000000000000", "2fac65010000000100000005000000e5530200e553020000000000000000009600000003000000000000000000000000", "2fac65010000000100000006000000e8530200e853020000000000000000001400000003000000000000000000000000", "3bac650100000001000000070000002c5a020049590200000000000000000032000000020000000000000000000000cad5bcafcce6b4fac6b7b0fc00", "2fac650100000001000000080000007a590200765902000000000000000000c800000002000000000000000000000000", "2fac65010000000100000009000000285902002859020000000000000000001e00000004000000000000000000000000", "2fac6501000000010000000a000000295902002959020000000000000000003200000001000000000000000000000000", "2